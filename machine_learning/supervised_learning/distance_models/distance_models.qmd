...
![Diagram of an SVM decision boundary. The red dots which were misclassified present a non-zero value for their slack variable $\xi_i$.](distance_models_assets/svm.png){#fig-svm width=60% fig-align="center"}
...
{{< embed distance_models_assets/svm.ipynb >}}