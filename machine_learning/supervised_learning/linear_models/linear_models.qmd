...
![Diagram of an EBM with $n$ features and $k$ iterations. In the end of the training, the trees of each feature are combined into a single linear function.](linear_models_assets/ebm.png){#fig-cv width=60% fig-align="center"}
