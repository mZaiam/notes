...
description: "During a Machine Learning pipeline, the goal is to select the best possible model to deploy. For that, model selection techniques are needed."
...
![Diagram of the holdout method.](model_selection_assets/holdout.png){#fig-holdout width=60% fig-align="center"}
...
![Diagram of the $k$-fold CV with $k=4$.](model_selection_assets/cv.png){#fig-cv width=60% fig-align="center"}

### Code

{{< embed model_selection.ipynb >}}