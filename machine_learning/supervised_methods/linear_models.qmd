...
{{< embed supervised_methods_assets/linear_regression.ipynb >}}
...
{{< embed supervised_methods_assets/logistic_regression.ipynb >}}
...
{{< embed supervised_methods_assets/glm.ipynb >}}
...
![Diagram of an EBM with $n$ features and $k$ iterations. In the end of the training, the trees of each feature are combined into a single linear function.](supervised_methods_assets/ebm.png){#fig-ebm width=60% fig-align="center"}

### Code: Generalized Linear Models

{{< embed supervised_methods_assets/ebm.ipynb >}}